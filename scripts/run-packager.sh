...
mkdir -p /var/www/origin/live/audio /var/www/origin/live/video_1080p /var/www/origin/live/video_720p /var/www/origin/live/video_480p

exec packager \
  'in=udp://0.0.0.0:5000?reuse=1,stream=audio,init_segment=/var/www/origin/live/audio/init.mp4,segment_template=/var/www/origin/live/audio/segment_$Number$.m4s,playlist_name=/var/www/origin/live/audio/index.m3u8,hls_group_id=audio,hls_name=ENGLISH' \
  'in=udp://0.0.0.0:5000?reuse=1,stream=video,init_segment=/var/www/origin/live/video_1080p/init.mp4,segment_template=/var/www/origin/live/video_1080p/segment_$Number$.m4s,playlist_name=/var/www/origin/live/video_1080p/index.m3u8,iframe_playlist_name=/var/www/origin/live/video_1080p/iframes.m3u8' \
